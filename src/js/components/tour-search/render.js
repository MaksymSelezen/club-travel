...
//   FILTER_LABELS,
// } from './constants.js';
// import { getPriceRangeState, isPriceRangeDefault } from './price-range.js';
// import {
//   escapeHtml,
//   getCountryValue,
...
//   ];
//   const priceState = getPriceRangeState(root);
//   const hasActivePrice = !isPriceRangeDefault(priceState);

//   container.innerHTML = ACTIVE_FILTERS_LABEL;

//   if (!checked.length && !hasActivePrice) return;
...
//       if (name === 'price') {
//         tag.dataset.tourSearchTagName = 'price';
//         tag.dataset.tourSearchTag = 'price';
//         tag.textContent = `Цена: ${input.min}€ — ${input.max}€`;
//       } else {
